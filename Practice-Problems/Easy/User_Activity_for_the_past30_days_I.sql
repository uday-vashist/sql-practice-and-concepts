...
-- 1️ Filter rows within the required date range

-- 2️ Group by activity_date

-- 3️ Count distinct users per day

-- 4️ Rename activity_date as 'day'
-- =========================================================
...
-- 1️ DISTINCT ensures a user is counted once per day,
--     even if they have multiple activities.

-- 2️ BETWEEN is inclusive:
--     Both start and end dates are included.

-- 3️ GROUP BY activity_date returns one row per day.
